with bms_machine_sizing_by_database as (
select a.db_name, a.dbversion, a.dbid,
      ...
      min(cast(b.cores as int64) - a.bms_host_machine_cores) over(partition by a.db_name, a.dbid) as min_bms_machine,
      a.bms_database_memory_gb,
      a.bms_db_tb_disk_for_iops,
      a.bms_est_monthly_storage_bill
from `MYDATASET.vbms_sizing_summperdb` a
...
select a.db_name, a.dbversion, a.dbid,
      ...
      a.bms_db_tb_disk_for_iops,
      a.bms_est_monthly_storage_bill
from bms_machine_sizing_by_database a
