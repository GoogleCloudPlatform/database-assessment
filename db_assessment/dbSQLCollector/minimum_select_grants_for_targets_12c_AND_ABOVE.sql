...
grant alter session to &&dbusername container=all;
...
grant select on sys.cdb_hist_snapshot to &&dbusername container=all;
grant select on sys.dba_hist_sysstat to &&dbusername container=all;
grant select on sys.cdb_hist_sysstat to &&dbusername container=all;
grant select on sys.dba_hist_sys_time_model to &&dbusername container=all;
grant select on sys.cdb_hist_sys_time_model to &&dbusername container=all;
grant select on sys.dba_hist_sqltext to &&dbusername container=all;
grant select on sys.cdb_hist_sqltext to &&dbusername container=all;
grant select on sys.dba_hist_osstat to &&dbusername container=all;
grant select on sys.cdb_hist_osstat to &&dbusername container=all;
grant select on sys.dba_hist_sysmetric_history to &&dbusername container=all;
grant select on sys.cdb_hist_sysmetric_history to &&dbusername container=all;
grant select on sys.dba_hist_sysmetric_summary to &&dbusername container=all;
grant select on sys.cdb_hist_sysmetric_summary to &&dbusername container=all;
...
grant select on sys.cdb_hist_sqlstat to &&dbusername container=all;
...
grant select on sys.cdb_hist_active_sess_history to &&dbusername container=all;
grant select on sys.v_$SQLCOMMAND to &&dbusername container=all;
grant select on sys.cdb_external_tables to &&dbusername container=all;
grant select on sys.dba_hist_iostat_function to &&dbusername container=all;
grant select on sys.cdb_hist_iostat_function to &&dbusername container=all;
grant select on sys.dba_hist_system_event to &&dbusername container=all;
grant select on sys.cdb_hist_system_event to &&dbusername container=all;
grant select on sys.gv_$archive_dest to &&dbusername container=all;
