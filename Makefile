...
build-collector: clean-collector      ## Build the collector SQL scripts.
	...
	mkdir -p $(BUILD_DIR)/collector/oracle/sql/extracts/setup
	...
	cp scripts/collector/oracle/sql/extracts/ssetup/*.sql $(BUILD_DIR)/collector/oracle/sql/extracts/setup
