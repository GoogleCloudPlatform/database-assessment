...
SELECT
    ...
    QUOTENAME(CONVERT(NVARCHAR(255),a.name),'"') as name,
    QUOTENAME(CONVERT(NVARCHAR(255),a.status),'"') as status,
    QUOTENAME(CONVERT(NVARCHAR(255),a.global),'"') as global,
    QUOTENAME(CONVERT(NVARCHAR(255),a.session),'"') as session,
