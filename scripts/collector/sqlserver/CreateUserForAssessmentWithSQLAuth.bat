...
if /i "%1" == "-defaultCollectionCreds" set "defaultCreds=1"
...
PowerShell -nologo -NoExit -NoProfile -ExecutionPolicy Bypass -File .\createuserwithsqluser.ps1 -user %saUser% -pass %saPass%
goto done
