...
select chr(34) || :PKEY || chr(34) as pkey,
    ...
    chr(34) || src.table_schema || chr(34) as table_schema,
    chr(34) || src.table_type || chr(34) as table_type,
    chr(34) || src.table_name || chr(34) as table_name,
    chr(34) || src.total_object_size_bytes || chr(34) as total_object_size_bytes,
    chr(34) || src.object_size_bytes || chr(34) as object_size_bytes,
    chr(34) || src.sequence_scan || chr(34) as sequence_scan,
    chr(34) || src.live_tuples || chr(34) as live_tuples,
    chr(34) || src.dead_tuples || chr(34) as dead_tuples,
    chr(34) || src.modifications_since_last_analyzed || chr(34) as modifications_since_last_analyzed,
    ...
    chr(34) || src.vacuum_count || chr(34) as vacuum_count,
    chr(34) || src.analyze_count || chr(34) as analyze_count,
    ...
    chr(34) || src.index_blocks_read || chr(34) as index_blocks_read,
    chr(34) || src.toast_blocks_hit || chr(34) as toast_blocks_hit,
    chr(34) || src.toast_blocks_read || chr(34) as toast_blocks_read,
    chr(34) || src.toast_index_hit || chr(34) as toast_index_hit,
    chr(34) || src.toast_index_read || chr(34) as toast_index_read
from src;
