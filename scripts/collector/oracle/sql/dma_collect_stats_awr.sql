...
--prompt PKEY|CON_ID|HOUR|COMMAND_TYPE|CNT|AVG_BUFFER_GETS|AVG_ELASPED_TIME|AVG_ROWS_PROCESSED|AVG_EXECUTIONS|AVG_CPU_TIME|AVG_IOWAIT|AVG_CLWAIT|AVG_APWAIT|AVG_CCWAIT|AVG_PLSEXEC_TIME|COMMAND_NAME|DMA_SOURCE_ID|DMA_MANUAL_ID
--@sql/extracts/awr/awrhistcmdtypes.sql
--spool off


spool &outputdir./dma__awrhistosstat__&s_tag.
prompt PKEY|DBID|INSTANCE_NUMBER|HOUR|STAT_NAME|HH24_TOTAL_SECS|CUMULATIVE_VALUE|AVG_VALUE|MODE_VALUE|MEDIAN_VALUE|PERCENTILE_95|AVERAGED_PEAK|MIN_VALUE|MAX_VALUE|SUM_VALUE|COUNT|DMA_SOURCE_ID|DMA_MANUAL_ID
...
prompt PKEY|DBID|INSTANCE_NUMBER|HOUR|PROGRAM|MODULE|MACHINE|COMMAND_NAME|CNT|DMA_SOURCE_ID|DMA_MANUAL_ID
