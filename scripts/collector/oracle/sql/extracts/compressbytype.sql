...
WITH vcompresstype AS (
     ...
     FROM   (SELECT &s_a_con_id. AS con_id,
                    a.owner,
                    &s_compress_col. AS compress_for,
                    SUM(bytes / 1024 / 1024 / 1024) gbytes
             FROM   &s_tblprefix._tables a,
                    &s_tblprefix._segments b
             WHERE  &s_a_con_id. = &s_b_con_id.
                    AND a.owner = b.owner
...
@sql/extracts/exclude_schemas.sql
             ...
             SELECT &s_a_con_id.,
                    ...
                    &s_compress_col. AS compress_for,
                    SUM(bytes / 1024 / 1024 / 1024) gbytes
             FROM   &s_tblprefix._tab_partitions a,
                    &s_tblprefix._segments b
             WHERE  &s_a_con_id. = &s_b_con_id.
...
@sql/extracts/exclude_schemas.sql
             ...
             SELECT &s_a_con_id.,
                    ...
                    &s_compress_col. AS compress_for,
                    SUM(bytes / 1024 / 1024 / 1024) gbytes
             FROM   &s_tblprefix._tab_subpartitions a,
                    &s_tblprefix._segments b
             WHERE  &s_a_con_id. = &s_b_con_id.
                    AND a.table_owner = b.owner
                    AND a.table_name = b.segment_name
