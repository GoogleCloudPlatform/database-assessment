...
spool &outputdir./dma__archlogs__&s_tag.
prompt PKEY|LOG_START_DATE|HOUR|THREAD_NUM|DEST_ID|CNT|MBYTES|DMA_SOURCE_ID|DMA_MANUAL_ID
@sql/extracts/archlogs.sql
spool off


spool &outputdir./dma__backups__&s_tag.
...
spool &outputdir./dma__db_features__&s_tag.
...
spool &outputdir./dma__db_hwmark_statistics__&s_tag.
...
spool &outputdir./dma__db_instances__&s_tag.
prompt PKEY|INSTANCE_NUMBER|INSTANCE_NAME|HOST_NAME|VERSION|STATUS|DATABASE_STATUS|INSTANCE_ROLE|DMA_SOURCE_ID|DMA_MANUAL_ID
@sql/extracts/dbinstances.sql
spool off


spool &outputdir./dma__db_parameters__&s_tag.
prompt PKEY|INSTANCE_NUMBER|CON_ID|NAME|VALUE|DEFAULT_VALUE|ISDEFAULT|DMA_SOURCE_ID|DMA_MANUAL_ID
@sql/extracts/dbparameters.sql
spool off


spool &outputdir./dma__db_summary__&s_tag.
...
spool &outputdir./dma__dma_key_log__&s_tag.
prompt PKEY|DMASCRI|DB_|HOSTNAME|DB_NAME|INSTANCE_NAME|COLLECTION_T|DB_ID|C|DMA_SOURCE_ID|DMA_MANUAL_ID
@sql/extracts/dmakeylog.sql
spool off


@sql/&s_tenancy.

@sql/dma_collect_stats_&s_statssrc.

spool &outputdir./dma__db_lob_sizing__&s_tag.
...
spool &outputdir./dma__eoj__&s_tag.
