...
SELECT  CASE WHEN '&s_dbversion' LIKE '10%' OR  '&s_dbversion' = '111' THEN '&AWRDIR/sqlstats111.sql' ELSE '&AWRDIR/sqlstats.sql' END as t_sqlstats
FROM DUAL;
