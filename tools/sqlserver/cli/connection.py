"""CLI commands for SQL Server connection testing."""
...
def _exit_on_failure(success: bool) -> None:
    if not success:
        raise click.exceptions.Exit(1)  # pyright: ignore  # pyright: ignore


@click.group(name="connect")
def connect_group() -> None:
    """Test and manage SQL Server database connections."""
